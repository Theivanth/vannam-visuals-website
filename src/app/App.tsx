  ...
  return (
    <div className="min-h-screen text-[#2E2E2E] overflow-x-hidden" style={{ fontFamily: SANS, background: LIGHT_BG }}>
      ...
      <section className="relative h-screen min-h-[720px] overflow-hidden">
        <div className="absolute inset-0" style={{ background: "#1a100a" }}>
          <img src={imgBeachCouple} alt="Indian couple in traditional wedding attire dancing on a sandy beach"
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-end px-8 md:px-16 lg:px-24">
          <div className="max-w-xl text-right">
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}
              ...
              <span className="text-[10px] tracking-[0.44em] uppercase" style={{ fontFamily: SANS, color: GOLD }}>
            ...
            <motion.h1 initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }}
              ...
              style={{ fontFamily: SERIF, fontWeight: 700, fontSize: "clamp(44px, 7.5vw, 100px)" }}>
              Every Colour
              <br />
              <em style={{ fontFamily: CALISTO, fontWeight: 400, fontStyle: "italic" }}>Has A Story.</em>
            </motion.h1>
            ...
            <motion.p initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}
              ...
              We don't just capture moments.<br />We preserve emotions that last forever.
            </motion.p>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}
              ...
              <a href="#stories"
                ...
                style={{ background: DARK_BG }}>
                Explore Our Stories <ArrowRight size={12} />
              </a>
              <a href="#contact"
        ...
        <div className="max-w-[1380px] mx-auto">
          <FadeIn className="text-center mb-20">
            ...
            <h2 style={{ ...lightH, fontFamily: SERIF, fontWeight: 700, fontSize: "clamp(26px, 3.2vw, 42px)" }}>
              How Your Story{" "}
              <em style={{ fontFamily: CALISTO, fontWeight: 400, fontStyle: "italic" }}>Unfolds</em>
            </h2>
          </FadeIn>
          <div className="relative">
            <div className="hidden lg:block absolute top-[38px] left-[80px] right-[80px] h-px" style={{ background: `${DARK_BG}22` }} />
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-4">
              {PROCESS.map((step, i) => {
                const Icon = step.icon;
                return (
                  <FadeIn key={step.num} delay={i * 0.09} y={20}>
                    <div className="flex flex-col items-center text-center">
                      <div className="relative mb-6">
                        <div className="w-[76px] h-[76px] rounded-full flex items-center justify-center relative z-10"
                          style={{ border: `1px solid ${DARK_BG}33`, background: LIGHT_BG }}>
                          <div className="w-[56px] h-[56px] rounded-full flex items-center justify-center" style={{ background: `${DARK_BG}11` }}>
                            <Icon size={20} style={{ color: DARK_BG }} />
                          </div>
                        </div>
                        <span className="absolute -top-2 -right-1 text-[9px] tracking-wider px-1.5" style={{ fontFamily: SANS, fontWeight: 500, color: GOLD, background: LIGHT_BG }}>{step.num}</span>
                      </div>
                      <h3 className="text-xl mb-2" style={{ fontFamily: SERIF, fontWeight: 700, color: DARK_BG }}>{step.title}</h3>
                      <p className="text-[12.5px] leading-[1.85] font-light" style={{ color: `${DARK_BG}99` }}>{step.body}</p>
                    </div>
                  </FadeIn>
                );
              })}
          ...
          <FadeIn className="text-center mt-14">
            <a href="#contact"
              ...
              style={{ background: DARK_BG }}>
              Start Your Journey <ArrowRight size={12} className="group-hover:translate-x-1 transition-transform" />
            </a>
          </FadeIn>
        </div>
      </section>
